...
export const HL_DATASET = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Uhorkový šalát", value: 15, image: "🥒", difficulty: 1 },
    ...
    {
        category: "Vek slávnych budov (roky)",
        metric: "rokov",
        items: [
            { name: "Veľká pyramída", value: 4580, image: "🏛️", difficulty: 1 },
            { name: "Koloseum", value: 1946, image: "🏟️", difficulty: 1 },
            { name: "Eiffelova veža", value: 136, image: "🗼", difficulty: 1 },
            { name: "Socha Slobody", value: 139, image: "🗽", difficulty: 2 },
            { name: "Taj Mahal", value: 391, image: "🕌", difficulty: 2 },
            { name: "Big Ben", value: 166, image: "🇬🇧", difficulty: 2 },
            { name: "Bratislavský hrad", value: 918, image: "🏰", difficulty: 2 },
            { name: "Sagrada Família", value: 143, image: "⛪", difficulty: 3 },
            { name: "Veža v Pise", value: 851, image: "🏗️", difficulty: 2 },
            { name: "Notre-Dame", value: 861, image: "⛪", difficulty: 2 },
            { name: "Hagia Sophia", value: 1499, image: "🕌", difficulty: 3 },
            { name: "Stonehenge", value: 5100, image: "🪨", difficulty: 2 },
            { name: "Burj Khalifa", value: 15, image: "🏢", difficulty: 1 },
        ]
    },
    {
        category: "Najrýchlejšia rýchlosť (km/h)",
        metric: "km/h",
        items: [
            { name: "Gepard", value: 112, image: "🐆", difficulty: 1 },
            { name: "Usain Bolt", value: 44.7, image: "🏃", difficulty: 1 },
            { name: "Formule 1", value: 372, image: "🏎️", difficulty: 1 },
            { name: "Boeing 747", value: 920, image: "✈️", difficulty: 2 },
            { name: "Zvuk", value: 1235, image: "🔊", difficulty: 1 },
            { name: "Svetlo", value: 1079252849, image: "💡", difficulty: 1 },
            { name: "Víchrica (tornado)", value: 480, image: "🌪️", difficulty: 2 },
            { name: "Kulka z pištole", value: 1800, image: "💨", difficulty: 2 },
            { name: "Pes (greyhound)", value: 72, image: "🐕", difficulty: 2 },
            { name: "Kôň (cválanie)", value: 70, image: "🐎", difficulty: 2 },
            { name: "Tučniak (plávanie)", value: 36, image: "🐧", difficulty: 3 },
            { name: "Sokol sťahovavý", value: 389, image: "🦅", difficulty: 2 },
            { name: "Blesk", value: 360000, image: "⚡", difficulty: 3 },
            { name: "Space Shuttle", value: 28000, image: "🚀", difficulty: 2 },
        ]
    },
    {
    ...
    {
        category: "Rok vynálezu/vzniku",
        metric: "rok",
        items: [
            { name: "Koleso", value: -3500, image: "☸️", difficulty: 1 },
            { name: "Tlačiareň (Gutenberg)", value: 1440, image: "📜", difficulty: 2 },
            ...
            { name: "Televízor", value: 1927, image: "📺", difficulty: 2 },
            { name: "Röntgen", value: 1895, image: "🩻", difficulty: 3 },
            { name: "Penicilin", value: 1928, image: "💊", difficulty: 3 },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Mucha", value: 0.08, image: "🪰", difficulty: 1 },
            { name: "Vrana", value: 14, image: "🐦‍⬛", difficulty: 3 },
            { name: "Gorila", value: 40, image: "🦍", difficulty: 2 },
            { name: "Bocian", value: 25, image: "🦩", difficulty: 3 },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Afrika", value: 54, image: "🌍", difficulty: 2 },
            { name: "Ázia", value: 48, image: "🌏", difficulty: 2 },
            { name: "Južná Amerika", value: 12, image: "🌎", difficulty: 2 },
            { name: "Severná Amerika", value: 23, image: "🌎", difficulty: 2 },
            { name: "Oceánia", value: 14, image: "🌏", difficulty: 3 },
        ]
    },
    {
