...
-- First drop existing conflicting columns/types if they exist or simplify by altering
-- Note: 'status' in platform_lobbies was likely text or another enum. We'll cast it or drop/recreate.
...
ALTER TABLE platform_lobbies DROP COLUMN IF EXISTS selected_game; -- it was text
ALTER TABLE platform_lobbies ADD COLUMN selected_game platform_lobby_game DEFAULT 'quiz';

ALTER TABLE platform_lobbies ADD COLUMN settings JSONB DEFAULT '{}'::jsonb;
ALTER TABLE platform_lobbies ADD COLUMN active_match_id UUID DEFAULT NULL;
ALTER TABLE platform_lobbies ADD COLUMN version INT DEFAULT 1;
ALTER TABLE platform_lobbies ADD COLUMN closed_at TIMESTAMPTZ DEFAULT NULL;
ALTER TABLE platform_lobbies ADD COLUMN lobby_ttl_expires_at TIMESTAMPTZ DEFAULT NULL;
...
-- Note: We add FK from platform_lobbies to platform_matches securely 
-- (must do this after platform_matches is created)
